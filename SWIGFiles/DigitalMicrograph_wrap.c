...
#define SWIG_init    Dimpy_Init
#define SWIG_name    "dimpy"
#define SWIG_prefix  ""
...
extern "C" {
#endif
SWIGINTERN const char *_wrap_TagGroupIterator_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewInstanceObj(SWIG_as_voidptr(&TagGroupIterator), SWIGTYPE_p_class, 0 );
  if (value) {
...
SWIGINTERN const char *_wrap_TagGroupIterator_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  if (!value) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""TagGroupIterator""' of type '""class""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""TagGroupIterator""' of type '""class""'");
    } else {
      TagGroupIterator = *((class *)(argp));
    }
  }
  return NULL;
fail:
  return "TagGroupIterator";
}


SWIGINTERN const char *_wrap_Gatan_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewInstanceObj(SWIG_as_voidptr(&Gatan), SWIGTYPE_p_namespace, 0 );
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_Gatan_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(value, &argp, SWIGTYPE_p_namespace,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""Gatan""' of type '""namespace""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""Gatan""' of type '""namespace""'");
    } else {
      Gatan = *((namespace *)(argp));
    }
  }
  return NULL;
fail:
...
static swig_var_info swig_variables[] = {
    { SWIG_prefix "TagGroupIterator", 0, (swig_variable_func) _wrap_TagGroupIterator_get,(swig_variable_func) _wrap_TagGroupIterator_set},
    { SWIG_prefix "Gatan", 0, (swig_variable_func) _wrap_Gatan_get,(swig_variable_func) _wrap_Gatan_set},
    {0,0,0,0}
};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "_GATANPLUGIN_USES_LIBRARY_VERSION", SWIG_From_int((int)(2)));
  return TCL_OK;
}
SWIGEXPORT int Dimpy_SafeInit(Tcl_Interp *interp) {
