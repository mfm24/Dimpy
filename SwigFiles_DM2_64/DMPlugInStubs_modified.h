...
********************************************************************************************/
void ConvertUInt8ToDisplay8( const Image &src, long top, long left, long bottom, long 
...
// "threadsafe void AddCustomMenuGroup( dm_string title, dm_string names...)"
void  AddCustomMenuGroup( const char *title, const char *items );
...
const char *listener_script, const char *client_id );
...
********************************************************************************************/
void LinePlotImageDisplayGetImageToGroupTransform( const LinePlotImageDisplay &lpid, const 
ScriptObject &slice_id, const ScriptObject &ref_id, double *off_val, double *scale_val, double
*off_dim_0, double *scale_dim_0 );
...
slice.
********************************************************************************************/
void LinePlotImageDisplayGetSliceTransparency( const LinePlotImageDisplay &lpid, long slice_index, 
											  bool * doTransparent, double * transparency );

/********************************************************************************************
LinePlotImageDisplayGetSliceTransparencyStyle: Gets the transparencyStyle of the 'slice_index'th 
slice.
********************************************************************************************/
void LinePlotImageDisplayGetSliceTransparencyStyle( const LinePlotImageDisplay &lpid, long slice_index, 
											  uint32 * transparencyStyle );
...
********************************************************************************************/
void LinePlotImageDisplaySetImageToGroupTransform( const LinePlotImageDisplay &lpid, 
const ScriptObject &slice_id, const ScriptObject &ref_id, double off_val, double scale_val, 
double off_dim_0, double scale_dim_0 );
...
slice.
********************************************************************************************/
void LinePlotImageDisplaySetSliceTransparency( const LinePlotImageDisplay &lpid, long slice_index, 
												bool doTransparent, double transparency );
...
slice.
********************************************************************************************/
void LinePlotImageDisplaySetSliceTransparencyStyle( const LinePlotImageDisplay &lpid, uint32 slice_index, 
												uint32 transparencyStyle );
...
checking is performed.
********************************************************************************************/
void PackedLnModulusToImage( const Image &imageSrc, const Image &imageDst, float 
...
void SaveAsGatan3( const Image &argument_1, const String &file_path, bool inc_thumb );	// Dummy which can be removed?
...
********************************************************************************************/
bool TagGroupGetIndexedTagAsLongPoint( const TagGroup &tagGroup, long index, SSIZE_T *x, 
SSIZE_T *y );
...
********************************************************************************************/
bool TagGroupGetIndexedTagAsLongRect( const TagGroup &tagGroup, long index, SSIZE_T *t, SSIZE_T 
*l, SSIZE_T *b, SSIZE_T *r );
...
********************************************************************************************/
bool TagGroupGetTagAsList( const TagGroup &tagGroup, const char *tagPath, TagGroup 
							  &subGroup );
...
********************************************************************************************/
void TagGroupSetIndexedTagAsLongPoint( const TagGroup &tagGroup, long index, SSIZE_T x, SSIZE_T 
y );
...
********************************************************************************************/
void TagGroupSetIndexedTagAsLongRect( const TagGroup &tagGroup, long index, SSIZE_T t, SSIZE_T 
l, SSIZE_T b, SSIZE_T r );
...
********************************************************************************************/
void TurboFFT( const Image &buffer, const Image &fft, const Image &dark, const Image 
...
namespace Gatan
{
	namespace DM
	{
		...
		Window ShowImage( const DM_ObjectToken &img ); 
		...
		ImageDisplay ImageDocumentAddImageDisplay( const ImageDocument &imgDoc, const ImageDisplay &img_disp );
		...
		void TransferTagsAndApplyDataBar( const Image &dst_img, uint32 prompt_options ); // Deprecated, use AutoApplyDefaultLayout instead (RTH).

		void Throw( const Throwable &dm_throw );
		void PostException( const Throwable &dm_throw );
		Throwable NewThrowableFromString( ::Gatan::PlugIn::DM_Env *dm_env, const String &exception );
	...
	namespace DM
	{
		...
		bool IsProductLicensed( const char* productName );
#ifdef _DEBUG 
		bool Debug_IsProductLicensed( const char* productName );			// Only for DEBUG builds. Looks into tags instead of licenses!
#endif
		ulong CountProductFeatures( const char* productName );
		ulong GetNthProductFeature( const char* productName, ulong index );
	}

	namespace DM
	{
		void LinePlotImageDisplayAddPeakLabel( const LinePlotImageDisplay &lpid, float label_posX, float label_posY, const String &lbl );
		void LinePlotImageDisplayRemovePeakLabel( const LinePlotImageDisplay &lpid, float label_posX );
		void GetDefaultLinePlotDisplaySize( float *width, float *height );
	}
	
	namespace DM
	{
		typedef ScriptObject ScriptObjectList;
		ScriptObjectList NewObjectList( PlugIn::DM_Env *dm_env );
		ScriptObjectList NewObjectList( PlugIn::DM_Env *dm_env, const const_value_range<ScriptObject> &objs );
		ulong ObjectList_SizeOfList( PlugIn::DM_Env *dm_env, const ScriptObjectList &list_obj );
		void  ObjectList_ClearList( PlugIn::DM_Env *dm_env, const ScriptObjectList &list_obj );
		ScriptObject ObjectList_ObjectAt( PlugIn::DM_Env *dm_env, const ScriptObjectList &list_obj, ulong index );
		ulong ObjectList_ObjectsAt( PlugIn::DM_Env *dm_env, const ScriptObjectList &list_obj, ulong start_idx, ulong des_num, std::vector<ScriptObject> &objs );
		long  ObjectList_AddObjectToList( PlugIn::DM_Env *dm_env, const ScriptObjectList &list_obj, const ScriptObject &obj );
		void  ObjectList_AddObjectsToList( PlugIn::DM_Env *dm_env, const ScriptObjectList &list_obj, const const_value_range<ScriptObject> &objs );
		void  ObjectList_MergeFrom( PlugIn::DM_Env *dm_env, const ScriptObject &dst_list, const ScriptObject &src_list );
	}
	
	namespace DM
	{
		void ExecuteInMainThread( PlugIn::DM_Env *dm_env, const ScriptObject &obj, const String &method );
		void ExecuteInBackgroundThread( PlugIn::DM_Env *dm_env, const ScriptObject &obj, const String &method );
		void ExecuteInCOMFreeThreadedApartment( PlugIn::DM_Env *dm_env, const ScriptObject &obj, const String &method );

		DM::ScriptObject NewVoidProcCallback( const boost::function0<void> &func, const char_range &method_name );

		ulong_ptr_t AddMainThreadPeriodicTask( const ScriptObject &task_obj, const String &method_name, double period_s );
		ulong_ptr_t AddMainThreadPeriodicTask( const boost::function0<void> &task, double period_s );
		void RemoveMainThreadTask( ulong_ptr_t task_token );
		ulong_ptr_t AddBackgroundPeriodicTask( const ScriptObject &task_obj, const String &meth_name, double period_s );
		ulong_ptr_t AddBackgroundPeriodicTask( const boost::function0<void> &task, double period_s );
		void RemoveBackgroundTask( ulong_ptr_t task_token );
	}
}
